...
void btree::display_max()
{
    maxValue(root);
}

void btree::maxValue(node* root)
{   
    	node* current = root;
    ...
    cout << "Maximum value in Binary Search Tree is => " <<current->data<<endl;
}

void btree::display_min()
{
	minValue(root);
}

void btree::minValue(node* root)
{
		node* current = root;
	...
	cout<<" Minimum value of Binary Search Tree is => "<<current->data<<endl;
}
...
int main()
{
   ...
   cout<<"********* Perform Tree Operation ********* "<<endl;
    do
    {
        ...
        cout<<"\t 5. Find Max-Value in Binary Search Tree "<<endl;
        cout<<"\t 6. Find Min-Value in Binary Search Tree "<<endl;
	    cout<<"Enter the Choice= ";
        cin>>ch;
